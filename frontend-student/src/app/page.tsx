    ...
    <>
      ...
      <section id="about" className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-16">
          <h2 className="text-3xl font-bold text-center mb-8 text-gray-800 tracking-tight">¿Qué es CEMU?</h2>
          <p className="text-lg text-justify mb-8 text-gray-700 leading-relaxed">
