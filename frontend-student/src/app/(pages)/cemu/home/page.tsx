...
export const metadata = {
  title: "CEMU - Centro Empresa Universidad",
  description:
    "Página informativa sobre el CEMU de UNEATLANTICO",
};
    ...
    <>
      ...
      <section id="about" className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          <SectionTitle>¿Qué es CEMU?</SectionTitle>
          <p className="text-lg text-justify text-gray-700 leading-relaxed">
            El Centro Empresa Universidad (CEMU) de UNEATLANTICO tiene como objetivos
            facilitar a los alumnos la búsqueda de prácticas profesionales, fomentar su
            inserción en el mundo laboral, así como orientarles en la creación de su propia
            empresa. Para conseguir estos fines se ha creado una gran red de colaboración
            con empresas e instituciones que trabajan coordinadamente con la Universidad
            en materia de innovación, orientación profesional y emprendimiento.
          </p>
        </div>
      </section>
      ...
      <section id="services" className="bg-gray-100 py-12">
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          <SectionTitle>Servicios que ofrece el CEMU</SectionTitle>
          ...
          <div className="mb-8 mt-8">
            ...
            <hr className="border-t-2 border-yellow-200 mb-4 w-20" />
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-justify mb-4 text-gray-700 leading-relaxed">
              Acciones encaminadas a descubrir el mercado laboral...
            </p>
            <ul className="list-disc pl-5 text-lg text-justify text-gray-700 leading-relaxed">
